import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as c,c as o,a as e,b as n,d as l,e as v}from"./app-d551626e.js";const a={},r=v(`<h2 id="_0、前言" tabindex="-1"><a class="header-anchor" href="#_0、前言" aria-hidden="true">#</a> 0、前言</h2><hr><p>关于<code>promise、async/await</code>的使用相信很多小伙伴都比较熟悉了，但是提到<strong>事件循环机制输出结果</strong>类似的题目，你敢说都会？</p><p>试一试？</p><p>🌰1：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>async function async1 () {
